...
import { u as V, c as p, a as j } from "./index-WxTJUbsU.js";
import { c as z, u as q } from "./index-BOS8297p.js";
import { u as J } from "./index-nyDQUcyF.js";
import { c as Q, P as x, u as W } from "./index-CDSAOBSC.js";
import { jsx as d } from "react/jsx-runtime";
var h = "rovingFocusGroup.onEntryFocus", X = { bubbles: !1, cancelable: !0 }, b = "RovingFocusGroup", [y, G, Z] = z(b), [$, me] = Q(
  b,
  [Z]
...
var te = s.forwardRef((e, r) => {
  const {
    ...
    ...C
  } = e, v = s.useRef(null), I = J(r, v), t = q(g), [l = null, T] = j({
    prop: R,
    defaultProp: E,
    onChange: m
  }), [u, i] = s.useState(!1), S = W(a), k = G(c), A = s.useRef(!1), [L, P] = s.useState(0);
  return s.useEffect(() => {
    const n = v.current;
    if (n)
  ...
  (e, r) => {
    const {
      ...
      tabStopId: g,
      ...R
    } = e, E = V(), m = g || E, a = oe(O, c), w = a.currentTabStopId === m, C = G(c), { onFocusableItemAdd: v, onFocusableItemRemove: I } = a;
    return s.useEffect(() => {
      if (o)
        return v(), () => I();
    }, [o, v, I]), /* @__PURE__ */ d(
