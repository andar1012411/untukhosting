...
import { u as me } from "./index-nyDQUcyF.js";
import { u as G, P as pe } from "./index-CDSAOBSC.js";
import { jsx as ge } from "react/jsx-runtime";
import { c as ye } from "./createLucideIcon-DUBSZsqM.js";
var _ = 0;
function bt() {
  u.useEffect(() => {
...
var U = "focusScope.autoFocusOnMount", j = "focusScope.autoFocusOnUnmount", q = { bubbles: !1, cancelable: !0 }, be = "FocusScope", Ee = u.forwardRef((e, t) => {
  const {
    loop: n = !1,
    trapped: r = !1,
    onMountAutoFocus: c,
    ...
    ...s
  } = e, [a, S] = u.useState(null), y = G(c), p = G(i), f = u.useRef(null), v = me(t, (o) => S(o)), h = u.useRef({
    paused: !1,
    pause() {
      this.paused = !0;
    },
  ...
  u.useEffect(() => {
    if (r) {
      let o = function(m) {
        ...
        const g = m.target;
        a.contains(g) ? f.current = g : k(f.current, { select: !0 });
      }, l = function(m) {
        if (h.paused || !a) return;
        const g = m.relatedTarget;
        g !== null && (a.contains(g) || k(f.current, { select: !0 }));
      }, d = function(m) {
        if (document.activeElement === document.body)
          for (const b of m)
            b.removedNodes.length > 0 && k(a);
      };
      ...
      return a && E.observe(a, { childList: !0, subtree: !0 }), () => {
        document.removeEventListener("focusin", o), document.removeEventListener("focusout", l), E.disconnect();
      };
    }
    ...
    if (a) {
      ...
      if (!a.contains(o)) {
        ...
        a.addEventListener(U, y), a.dispatchEvent(d), d.defaultPrevented || (Se(Re(oe(a)), { select: !0 }), document.activeElement === o && k(a));
      }
      return () => {
        a.removeEventListener(U, y), setTimeout(() => {
          const d = new CustomEvent(j, q);
          a.addEventListener(j, p), a.dispatchEvent(d), d.defaultPrevented || k(o ?? document.body, { select: !0 }), a.removeEventListener(j, p), $.remove(h);
        }, 0);
      };
    }
  }, [a, y, p, h]);
  const w = u.useCallback(
    (o) => {
      ...
      if (l && d) {
        const E = o.currentTarget, [m, g] = we(E);
        m && g ? !o.shiftKey && d === g ? (o.preventDefault(), n && k(m, { select: !0 })) : o.shiftKey && d === m && (o.preventDefault(), n && k(g, { select: !0 })) : d === E && o.preventDefault();
      }
    },
    [n, r, h.paused]
  );
...
var Te = function(e) {
...
}, R = /* @__PURE__ */ new WeakMap(), O = /* @__PURE__ */ new WeakMap(), L = {}, K = 0, ce = function(e) {
  ...
  var c = Me(t, Array.isArray(e) ? e : [e]);
  L[n] || (L[n] = /* @__PURE__ */ new WeakMap());
  var i = L[n], s = [], a = /* @__PURE__ */ new Set(), S = new Set(c), y = function(f) {
  ...
  var p = function(f) {
    !f || S.has(f) || Array.prototype.forEach.call(f.children, function(v) {
      if (a.has(v))
        ...
        try {
          var h = v.getAttribute(r), w = h !== null && h !== "false", o = (R.get(v) || 0) + 1, l = (i.get(v) || 0) + 1;
          R.set(v, o), i.set(v, l), s.push(v), o === 1 && w && O.set(v, !0), l === 1 && v.setAttribute(n, "true"), w || v.setAttribute(r, "true");
        } catch (d) {
  ...
  return p(t), a.clear(), K++, function() {
    s.forEach(function(f) {
      var v = R.get(f) - 1, h = i.get(f) - 1;
      R.set(f, v), i.set(f, h), v || (O.has(f) || f.removeAttribute(r), O.delete(f)), h || f.removeAttribute(n);
    }), K--, K || (R = /* @__PURE__ */ new WeakMap(), R = /* @__PURE__ */ new WeakMap(), O = /* @__PURE__ */ new WeakMap(), L = {});
  };
}, Et = function(e, t, n) {
  n === void 0 && (n = "data-aria-hidden");
  var r = Array.from(Array.isArray(e) ? e : [e]), c = Te(e);
  return c ? (r.push.apply(r, Array.from(c.querySelectorAll("[aria-live]"))), Pe(r, c, n, "aria-hidden")) : function() {
    return null;
  };
}, C = function() {
...
var W = "right-scroll-bar-position", B = "width-before-scroll-bar", Fe = "with-scroll-bars-hidden", Oe = "--removed-body-scroll-bar-size";
function H(e, t) {
...
var Ie = typeof window < "u" ? u.useLayoutEffect : u.useEffect, ee = /* @__PURE__ */ new WeakMap();
function xe(e, t) {
...
var le = De(), V = function() {
}, D = u.forwardRef(function(e, t) {
  var n = u.useRef(null), r = u.useState({
    onScrollCapture: V,
    onWheelCapture: V,
    onTouchMoveCapture: V
  }), c = r[0], i = r[1], s = e.forwardProps, a = e.children, S = e.className, y = e.removeScrollBar, p = e.enabled, f = e.shards, v = e.sideCar, h = e.noIsolation, w = e.inert, o = e.allowPinchZoom, l = e.as, d = l === void 0 ? "div" : l, E = e.gapMode, m = ue(e, ["forwardProps", "children", "className", "removeScrollBar", "enabled", "shards", "sideCar", "noIsolation", "inert", "allowPinchZoom", "as", "gapMode"]), g = v, b = xe([n, t]), A = C(C({}, m), c);
  return u.createElement(
    u.Fragment,
    null,
    p && u.createElement(g, { sideCar: le, removeScrollBar: y, shards: f, noIsolation: h, inert: w, setCallbacks: i, allowPinchZoom: !!o, lockRef: n, gapMode: E }),
    s ? u.cloneElement(u.Children.only(a), C(C({}, A), { ref: b })) : u.createElement(d, C({}, A, { className: S, ref: b }), a)
  );
});
D.defaultProps = {
  enabled: !0,
...
}, Ze = se(), P = "data-scroll-locked", qe = function(e, t, n, r) {
...
var T = Y ? { passive: !1 } : !1, Je = function(e) {
  ...
  var i = at(e, window.getComputedStyle(t).direction), s = i * r, a = n.target, S = t.contains(a), y = !1, p = s > 0, f = 0, v = 0;
  do {
    var h = ve(e, a), w = h[0], o = h[1], l = h[2], d = o - l - i * w;
    (w || d) && de(e, a) && (f += d, v += w), a instanceof ShadowRoot ? a = a.host : a = a.parentNode;
  } while (
    // portaled content
    !S && a !== document.body || // self content
    S && (t.contains(a) || t === a)
  );
  return (p && Math.abs(f) < 1 || !p && Math.abs(v) < 1) && (y = !0), y;
}, x = function(e) {
...
function lt(e) {
  var t = u.useRef([]), n = u.useRef([0, 0]), r = u.useRef(), c = u.useState(it++)[0], i = u.useState(se)[0], s = u.useRef(e);
  u.useEffect(function() {
    s.current = e;
  ...
  var a = u.useCallback(function(o, l) {
    ...
    var d = x(o), E = n.current, m = "deltaX" in o ? o.deltaX : E[0] - d[0], g = "deltaY" in o ? o.deltaY : E[1] - d[1], b, A = o.target, N = Math.abs(m) > Math.abs(g) ? "h" : "v";
    ...
    if (F ? b = N : (b = N === "v" ? "h" : "v", F = ne(N, A)), !F)
      return !1;
    if (!r.current && "changedTouches" in o && (m || g) && (r.current = b), !b)
      return !0;
    var z = r.current || b;
    return ot(z, l, o, z === "h" ? m : g);
  }, []), S = u.useCallback(function(o) {
    var l = o;
    if (!(!M.length || M[M.length - 1] !== i)) {
      var d = "deltaY" in l ? re(l) : x(l), E = t.current.filter(function(b) {
        return b.name === l.type && (b.target === l.target || l.target === b.shadowParent) && ct(b.delta, d);
      })[0];
      if (E && E.should) {
      ...
      if (!E) {
        var m = (s.current.shards || []).map(ae).filter(Boolean).filter(function(b) {
          return b.contains(l.target);
        }), g = m.length > 0 ? a(l, m[0]) : !s.current.noIsolation;
        g && l.cancelable && l.preventDefault();
      }
    }
  }, []), y = u.useCallback(function(o, l, d, E) {
    var m = { name: o, delta: l, target: d, should: E, shadowParent: st(d) };
    ...
    y(o.type, re(o), o.target, a(o, e.lockRef.current));
  ...
  u.useEffect(function() {
    return M.push(i), e.setCallbacks({
      ...
      onWheelCapture: f,
      onTouchMoveCapture: v
    }), document.addEventListener("wheel", S, T), document.addEventListener("touchmove", S, T), document.addEventListener("touchstart", p, T), function() {
      M = M.filter(function(o) {
        return o !== i;
      }), document.removeEventListener("wheel", S, T), document.removeEventListener("touchmove", S, T), document.removeEventListener("touchstart", p, T);
    };
  }, []);
  ...
  return u.createElement(
    ...
    h ? u.createElement($e, { gapMode: e.gapMode }) : null
  );
}
function st(e) {
...
var dt = u.forwardRef(function(e, t) {
  return u.createElement(D, C({}, e, { ref: t, sideCar: ft }));
});
dt.classNames = D.classNames;
/**
 ...
 */
const vt = [["path", { d: "M20 6 9 17l-5-5", key: "1gmf2c" }]], St = ye("Check", vt);
export {
  St as C,
  Ee as F,
  dt as R,
